...
namespace Ecomm_project_1145_2.Areas.Identity.Pages.Account
{
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    //Assign Admin Role
                    //await _userManager.AddToRoleAsync(user,SD.Role_Admin);      //after assign admin role the comment this line
